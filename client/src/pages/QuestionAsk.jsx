...
export default function QuestionAsk() {
    ...
    const [secondBtnActive, setSecondBtnActive] = useState({
        display: "block",
    });
    const [submitBtnActive, setSubmitBtnActive] = useState({
        display: "block",
    });
    ...
    const addQuestion = async (value) => {
        try {
            await axios.post(`http://localhost:9600/questions`, {
                title: value,
                contents: firstBody + secondBody,
            });
        } catch (error) {
            console.error(error);
        }
                ...
                <LayoutContainer>
                    ...
                    <Container>
                        <QuestionBody>
                            ...
                            <BtnContainer>
                                ...
                                <NextBtn onClick={onActiveSecondBody}>
                                    Next
                                </NextBtn>
                            </BtnContainer>
                        </QuestionBody>
                    ...
                    <Container>
                        <QuestionTags>
                            ...
                            <NextBtn
                                onClick={() =>
                                    setSubmitBtnActive({ display: "none" })
                                }
                            >
                                Next
                            </NextBtn>
                    ...
                    <BtnContainer>
                        ...
                        <DiscardBtn onClick={onDiscardModal}>
                            Discard draft
                        </DiscardBtn>
                    </BtnContainer>
                </LayoutContainer>
